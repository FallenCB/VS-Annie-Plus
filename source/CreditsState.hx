...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		[''],
		["VS Annie Plus Creator"],
		['FallenCB',		'fallencb',	"All of the coding for VS Annie Plus",				'https://www.youtube.com/channel/UC3hc4f4ivvue5z9KgQsU8aA',	'0xFF53E52C'],
		[''],
		["Original Creator of VS Annie"],
		['Atsuover',		'atsuover',	"VS Annie",				'https://www.youtube.com/c/atsuover',	'0xFFF73838'],
	];
